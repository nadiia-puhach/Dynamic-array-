...
int main(){
    ...
    try {
        std::cout << "\nFifth element in third array is: " << third[4] << std::endl;
    ...
    try {
        std::cout << third[ third.getSize() + 2] ;
    }
    catch (const indexError& err) {
        std::cout << "Error(" << std::endl;
    }
    ...
    vector empty(0);
    if (empty){
        std::cout << "empty array isn`t empty" << std::endl;
    }
    else {
        std::cout << "empty array is empty" << std::endl;
    }

    if (third){
        std::cout << "third array isn`t empty" << std::endl;
    }
    else {
        std::cout << "third array is empty" << std::endl;
    }
